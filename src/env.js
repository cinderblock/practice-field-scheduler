...
export const env = createEnv({
	...
	server: {
		...
		OPENMETEO_API_KEY: z.string().min(1).optional(),
		WEATHER_UPDATE_FREQUENCY: z
			.string()
			.transform(val => Number.parseInt(val, 10))
			.refine(num => num > 0, "Weather update frequency must be a positive number")
			.default("96"),
	...
	runtimeEnv: {
		...
		OPENMETEO_API_KEY: process.env.OPENMETEO_API_KEY,
		WEATHER_UPDATE_FREQUENCY: process.env.WEATHER_UPDATE_FREQUENCY,
